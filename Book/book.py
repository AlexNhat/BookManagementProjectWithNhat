...
class Ui_BOOK_Anhnhat(object):
    def setupUi(self, BOOK_Anhnhat):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(0, 110, 651, 181))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")
        self.gridLayout = QtWidgets.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setContentsMargins(0, 0, 0, 0)
        self.gridLayout.setObjectName("gridLayout")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 460, 641, 31))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.xac_nhan = QtWidgets.QPushButton(self.centralwidget)
        self.xac_nhan.setGeometry(QtCore.QRect(480, 340, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.xac_nhan.setFont(font)
        self.xac_nhan.setObjectName("xac_nhan")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 420, 651, 21))
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.Result = QtWidgets.QLabel(self.centralwidget)
        self.Result.setGeometry(QtCore.QRect(100, 310, 371, 91))
        font = QtGui.QFont()
        font.setPointSize(12)
    ...
    def retranslateUi(self, BOOK_Anhnhat):
        ...
        self.xac_nhan.setText(_translate("BOOK_Anhnhat", "Xác Nhận"))

        self.xac_nhan.clicked.connect(self.cau2_1)
    ...
    def addbook(self):
        try:
            self.line_ma.setText()
            self.line_ten.setText("Anh Nhật")
            self.line_tac.setText("")
            self.line_gia.setText("")
            self.line_da.setText("")
            self.line_ton.setText("")
            self.chon_nam.currentText()

            st={}
            st["mã sách"]= self.line_ma.text()
            st["Tên sách"]= self.line_ten.text()
            st["Tác giã"]= self.line_tac.text()
            st["Giá bán"]= self.line_gia.text()
            st["Đã bán"]= self.line_da.text()
            st["Tồn kho"]= self.line_ton.text()
            st["Năm"]= self.chon_nam.currentText()
        except ValueError as ex:
            print(ex)
        return st
    def cau2_1(self):
        add_book=self.addbook()
        k=self.Result.setText(add_book)
        with open("booknhat.json", "w") as book:
            json.dump(k,book)
